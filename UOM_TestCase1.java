    ...
    @BeforeClass
        ...
        public void VerifyUOMWorkflowTestCase1() throws Exception {
            ...
            try {
                ...
                CommonUtil.Explicitwait_Clickable(unitOfMeasure.Done_Button);
                ...
                test.log(LogStatus.PASS,"Unit of Measure name: Group", test.addBase64ScreenShot(Utils.captureScreenshot("UOM_TestCase1")));
                ...
                String UOM_NAME=CommonUtil.Get_Text(unitOfMeasure.Capture_UOM_Name);
                ...
                cf.MoveToElement(cf.waitForElement(pg.Assessment_Status));
                ...
                cf.MoveToElement(cf.waitForElement(pg.Assessment_Status));//move to the element
                ...
                LOG.info("Add Scenario");
                CommonUtil.clickOnElement(unitOfMeasure.Save3);
                CommonUtil.secondsDelay(2);
                CommonUtil.Explicitwait_Clickable(unitOfMeasure.Close_Navigator);
                CommonUtil.clickOnElement(unitOfMeasure.Close_Navigator);
                cf.MoveToElement(cf.waitForElement(pg.Analysis_table));
                CommonUtil.secondsDelay(3);
                test.log(LogStatus.PASS, "Created scenario", test.addBase64ScreenShot(Utils.captureScreenshot("UOM_TestCase1")));
                ...
                CommonUtil.secondsDelay(4);
                cf.MoveToElement(cf.waitForElement(pg.Assessment_Status));
                CommonUtil.clickOnElement(unitOfMeasure.Status);
                ...
                cf.javaScriptClick(cf.waitForElement(pg.UnitOfMeasure_menu));
                //CommonUtil.secondsDelay(3);
                CommonUtil.Explicitwait_Clickable(unitOfMeasure.Search_Uni_Of_Measure);
